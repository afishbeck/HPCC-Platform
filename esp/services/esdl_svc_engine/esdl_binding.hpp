...
public:
    ...
    EsdlBindingImpl();
    EsdlBindingImpl(IPropertyTree* cfg, IPropertyTree *esdlBundle, const char *bindname=NULL, const char *procname=NULL);
    ...
    void addService(IPropertyTree *esdlBundle, const char * name, const char * host, unsigned short port, IEspService & service);
...
private:
    ...
    bool loadLocalDefinitions(IPropertyTree *esdlBundle, const char * espServiceName, Owned<IEsdlDefinition>& esdl, IPropertyTree * config, StringBuffer & loadedServiceName);
