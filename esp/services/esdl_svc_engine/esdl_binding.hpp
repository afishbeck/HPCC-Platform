...
private:
    ...
    Owned<IEsdlTransformMap> m_requestTransforms;
    Owned<IEsdlTransformMap> m_prelogTransforms;
...
public:
    ...
    EsdlServiceImpl()
    {
        m_requestTransforms.setown(createEsdlTransformMap());
        m_prelogTransforms.setown(createEsdlTransformMap());;
    }
    ...
    void handleTransformError(bool &serviceError, TransformErrorMap &methodErrors, IException *e, const char *tag, const char *service, const char *method);
    void addTransforms(IEsdlTransformMap *tfm, IPropertyTree *cfgParent, const char *tag, const char *service, const char *method);
    void addServiceTransforms(IEsdlTransformMap *tfm, IPropertyTree *cfgParent, const char *tag, const char *service);
