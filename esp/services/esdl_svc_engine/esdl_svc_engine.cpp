...
CEsdlSvcEngineSoapBindingEx::CEsdlSvcEngineSoapBindingEx(IPropertyTree* cfg, IPropertyTree *esdlBundle, const char *bindname, const char *procname) : EsdlBindingImpl(cfg, esdlBundle, bindname, procname)
{
}
