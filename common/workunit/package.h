...
interface IHpccPackageMap : extends IInterface
{
    ...
    virtual bool validate(StringArray &queriesToVerify, StringArray &warn, StringArray &err, StringArray &unmatchedQueries, StringArray &unusedPackages, IReferencedFileList &filelist) const = 0;
