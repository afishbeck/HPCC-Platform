...
interface IHpccPackageMap : extends IInterface
{
    ...
    virtual bool validate(StringArray &queriesToVerify, StringArray &warn, StringArray &err, StringArray &unmatchedQueries, StringArray &unusedPackages, IPropertyTree &unmatchedFiles) const = 0;
