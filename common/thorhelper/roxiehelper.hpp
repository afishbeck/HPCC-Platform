...
public:
    ...
    TextMarkupFormat queryPTreeFormat(){return (strieq(queryContentType(), "application/json")) ? MarkupFmt_JSON : MarkupFmt_XML;}
};
...
public:
    ...
    const char *getFormatDescription()
    {
        switch (mlFmt)
        {
        case MarkupFmt_XML:
