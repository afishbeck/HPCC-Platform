...
output(ds,,'REGRESS::TEMP::output_inline_xpath_orig.xml', overwrite, xml);

readWrittenOrig := dataset(DYNAMIC('REGRESS::TEMP::output_inline_xpath_orig.xml'), L0Rec, xml('Dataset/Row'));
...
output(x,,'REGRESS::TEMP::output_inline_xpath_named.xml', overwrite, xml);

readWrittenNamed := dataset(DYNAMIC('REGRESS::TEMP::output_inline_xpath_named.xml'), L1Rec, xml('Dataset/Row'));
...
output(y,,'REGRESS::TEMP::output_inline_xpath_unnamed.xml', overwrite, xml);
...
readWrittenUnnamed := dataset(DYNAMIC('REGRESS::TEMP::output_inline_xpath_unnamed.xml'), R2Rec, xml('Dataset/Row'));
...
output(z,,'REGRESS::TEMP::output_inline_xpath_noname.xml', overwrite, xml);
...
readWrittenNoname := dataset(DYNAMIC('REGRESS::TEMP::output_inline_xpath_noname.xml'), R3Rec, xml('Dataset/Row'));
