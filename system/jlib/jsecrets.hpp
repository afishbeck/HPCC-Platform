...
extern jlib_decl IPropertyTree *queryTlsClientSecretInfo(const char *issuer, bool mutual, bool acceptSelfSigned, bool addCACert=true);
extern jlib_decl IPropertyTree *queryEclClientSecretInfo(const char *secretname, bool mutual, bool acceptSelfSigned, bool addCACert=true);
