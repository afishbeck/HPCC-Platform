...
extern jlib_decl IPropertyTree *getTlsSecretInfoWithTrustedPeers(const char *issuer, const char *trusted_peers);

extern jlib_decl IPropertyTree *createTlsClientSecretInfo(const char *issuer, bool acceptSelfSigned, bool addCACert=true);
