...
public:
    ...
    CommonReaderBase(const void *_buf, size32_t bufLength, IPTreeNotifyEvent &_iEvent, XmlReaderOptions _readerOptions) : readerOptions(_readerOptions), iEvent(&_iEvent)
    {
    ...
    CommonReaderBase(const void *_buf, IPTreeNotifyEvent &_iEvent, XmlReaderOptions _readerOptions) : readerOptions(_readerOptions), iEvent(&_iEvent)
    {
        bufSize = 0; // not used for direct reads
        stream = NULL;  // not used for direct reads
        curOffset = 0;
