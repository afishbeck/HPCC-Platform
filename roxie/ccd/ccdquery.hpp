...
interface IQueryFactory : extends IInterface
{
    ...
    virtual IRoxieServerContext *createContext(IPropertyTree *xml, IHpccProtocol *protocol, unsigned flags, const ContextLogger &_logctx, PTreeReaderOptions xmlReadFlags, const char *querySetName) const = 0;
