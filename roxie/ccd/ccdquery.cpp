...
public:
    ...
    virtual IRoxieServerContext *createContext(IPropertyTree *xml, IHpccProtocol *protocol, unsigned flags, const ContextLogger &_logctx, PTreeReaderOptions xmlReadFlags, const char *querySetName) const
    {
...
public:
    ...
    virtual IRoxieServerContext *createContext(IPropertyTree *context, IHpccProtocol *protocol, unsigned flags, const ContextLogger &_logctx, PTreeReaderOptions _xmlReadFlags, const char *_querySetName) const
    {
        checkSuspended();
