...
{
    virtual IHpccProtocolListener *createListener(const char *protocol, IHpccProtocolMsgSink *sink, unsigned port, unsigned listenQueue, const char *config, const char *certIssuer, const char *certFile, const char *keyFile, const char *passPhrase)=0;
};
