...
public:
    ...
    {
        return queryFactory ? queryFactory->queryOptions().priority : 0;
    }
...
public:
    ...
    virtual void query(IHpccProtocolMsgContext *msgctx, IPropertyTree *msg, IHpccProtocol *protocol, unsigned flags, PTreeReaderOptions xmlReadFlags, const char *target, unsigned idx, unsigned &memused, unsigned &slavesReplyLen)
    {
    ...
    virtual void control(IHpccProtocolMsgContext *msgctx, IPropertyTree *msg, const char *xmltext, StringBuffer &reply)
    {
        RoxieProtocolMsgContext *roxieMsgCtx = checkGetRoxieMsgContext(msgctx, msg);
