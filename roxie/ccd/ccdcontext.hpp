...
interface IRoxieServerContext : extends IInterface
{
    ...
    virtual void finalize(unsigned seqNo) = 0; //adf more than flushing, this builds response message
    ...
    virtual IHpccProtocol *queryProtocol() = 0;
};
...
extern IRoxieServerContext *createRoxieServerContext(IPropertyTree *context, IHpccProtocol *protocol, const IQueryFactory *factory, unsigned flags, const ContextLogger &logctx, PTreeReaderOptions xmlReadFlags, const char *querySetName);
