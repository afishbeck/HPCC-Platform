...
public:
    ...
    virtual void usage()
    {
        fputs("\nUsage:\n"
            ...
            "   --only-copy-files      Copy the files needed for the query, but don't copy the query\n"
...
private:
    ...
    bool optDfuCopyFiles = false; //copy files during deployment, not on roxie in the background
...
public:
    ...
    virtual void usage()
    {
        fputs("\nUsage:\n"
            ...
            "   --no-files             Do not copy DFS file information for referenced files\n"
            "   --dfu-copy             Use DFU to copy files during deployment, not on roxie in the background\n"
            "   --only-copy-files      Copy the files needed for the queries, but don't copy the queryset\n"
            "   --daliip=<ip>          Remote Dali DFS to use for copying file information\n"
            "   --source-process       Process cluster to copy files from\n"
...
public:
    ...
    virtual void usage()
    {
        fputs("\nUsage:\n"
            ...
            "   --no-files             Do not copy DFS file information for referenced files\n"
            "   --dfu-copy             Use DFU to copy files during deployment, not on roxie in the background\n"
            "   --only-copy-files      Copy the files needed for the queries, but don't import the queryset\n"
            "   --daliip=<ip>          Remote Dali DFS to use for copying file information\n"
            "   --source-process       Process cluster to copy files from\n"
            "   --clone-active-state   Make copied queries active if active on source\n"
            "   -O, --overwrite        Completely replace existing DFS file information (dangerous)\n"
