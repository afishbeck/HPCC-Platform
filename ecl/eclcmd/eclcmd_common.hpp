    ...
    virtual void usage()
    {
        ...
        if (usesESP)
            fprintf(stdout,
                ...
                "   --client-cert          Path to file containing SSL client certificate\n"
                "   --client-private-key   Path to file containing SSL client certificate private key\n"
                "   --ca-cert              Path to file containing SSL CA certificate\n"
